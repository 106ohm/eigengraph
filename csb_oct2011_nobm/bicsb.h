...
private:
	...
	template <typename SR, typename RHS, typename LHS>	
	void BTransMult(IT, IT rowstart, IT rowend, const RHS * __restrict x, LHS * __restrict y, IT ysize) const;
...
private:
	...
	template <typename SR, typename RHS, typename LHS>		
	void BTransMult(IT col, IT rowstart, IT rowend, const RHS * __restrict x, LHS * __restrict y, IT ysize) const;
